# -*- coding: utf-8 -*-
"""
Created on Sun Feb 25 02:26:12 2024

@author: david.tapiap

This file adapts the RiverSwim Preference environment in order to model the 
irrational teachers of the B-Pref testbench.

RiverSwim Preference environment is as described in "Dueling Posterior Sampling
...
class RiverSwimPreferenceEnvBPref(RiverSwimPreferenceEnv):
    """
    This class is a wrapper for the RiverSwim Preference Environment which 
    ...
    def __init__(self, user_noise_type, num_states = 6, beta=np.inf, gamma=1,
        ...
        *   The default teacher is the Oracle.
        ...
        if beta == np.inf:
            user_noise_model[1]=0   # Just in case somebody tries to model a perfectly
                                    ...
                                    # noise type.
        super().__init__(user_noise_model,num_states)
